...
class View
{
    function beranda($data)
    {
        ...
        <body>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#edit-<?php echo $key['nim']; ?>"> Edit </button>
            ...
            foreach ($data as $key) {
                ?>
                <div class="modal fade" id="edit-<?php echo $key['nim']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-11">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="editNIM" name="nim_baru"
                                                    value="<?php echo $key['nim']; ?>">
                                            </div>
                                            <div class="form-group">
